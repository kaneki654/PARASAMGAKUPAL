...
class Bypasser(HackingTool):
    TITLE = "403Bypasser - Bypass 403 errors"
    DESCRIPTION = "403bypasser is a bypasser to bypass 403 HAHAHA rawr. " \
                  "its for us only tns bruh."
    INSTALL_COMMANDS = [
        "git clone https://github.com/yunemse48/403bypasser.git"
        "cd 403bypasser;pip install -r requirements.txt"
    ]
    RUN_COMMANDS = ["cd 403bypasser;python 403bypasser.py"]
    PROJECT_URL = "https://github.com/yunemse48/403bypasser"
