...
class StegnoCracker(HackingTool):
    TITLE = "StegnoCracker - Tool that uncover hidden data inside"
...
class StegoCracker(HackingTool):
    TITLE = "StegoCracker - hide data into image or audio files and can retrieve from a file"
...
class Whitespace(HackingTool):
    TITLE = "Whitespace - unicode chars for steganography"
